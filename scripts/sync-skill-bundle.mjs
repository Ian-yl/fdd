...
for (const file of ['import-productforge.mjs', 'scaffold-package.mjs', 'review-package.mjs', 'validate-package.mjs', 'migrate-package.mjs', 'build-implementation-handoff.mjs', 'review-implementation-handoff.mjs']) cpSync(`${root}/scripts/${file}`, `${skill}/scripts/${file}`);
